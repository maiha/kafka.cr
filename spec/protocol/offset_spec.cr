...
describe Kafka::Protocol::OffsetRequest do
  ...
  let(req) {
    Kafka::Protocol::OffsetRequest.new(
      correlation_id = 0,
  ...
  it "to_kafka" do
    expect(req.to_slice).to eq(bytes(0, 0, 0, 54, 0, 2, 0, 0, 0, 0, 0, 0, 0, 12, 107, 97, 102, 107, 97, 45, 111, 102, 102, 115, 101, 116, 255, 255, 255, 255, 0, 0, 0, 1, 0, 2, 116, 49, 0, 0, 0, 1, 0, 0, 0, 0, 255, 255, 255, 255, 255, 255, 255, 255, 59, 154, 201, 255))
  end
end
